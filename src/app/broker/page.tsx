            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-2">
              ...
              <section className="rounded-md bg-panel p-4">
                ...
                <div className="mt-4 grid gap-2">
                  <a className="button text-center" href={`mailto:admin@example.com?subject=Rueckfrage%20${encodeURIComponent(property.name)}`}>Nachricht senden</a>
                  <a className="button-secondary text-center" href={`mailto:admin@example.com?subject=Unterlagen%20anfordern%20${encodeURIComponent(property.name)}`}>Unterlagen anfordern</a>
                </div>
              </section>
            </div>
          </article>
