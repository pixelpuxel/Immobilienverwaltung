      ...
      {user.role === Role.ADMIN ? (
        ...
        <section className="mt-8 rounded-lg border border-line p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <a className="button" href="mailto:admin@example.com?subject=Rueckfrage%20Immobilienportal">Nachricht senden</a>
            <a className="button-secondary" href="mailto:admin@example.com?subject=Unterlagen%20anfordern">Unterlagen anfordern</a>
          </div>
        </section>
      ) : null}
    </AppShell>
