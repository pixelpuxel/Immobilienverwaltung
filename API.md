...
```text
https://portal.schreiber.info
```

In den Beispielen wird eine Variable verwendet:

```bash
BASE_URL="http://192.168.0.180:8088"
```

Fuer die VM:

```bash
BASE_URL="https://portal.schreiber.info"
```
...
```bash
VM_URL="https://portal.schreiber.info"
...
```bash
NAS_URL="http://192.168.0.180:8088"
