...
Fuer N8N und andere externe Automationen gibt es eine eigene API-Token-Integrations-API. Die Token werden technisch als Bearer-Token gesendet; Endpunkte und Beispiele stehen in [N8N_API.md](./N8N_API.md).
